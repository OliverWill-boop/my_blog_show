...
### 技巧 2：@ 引用文件 —— 精准指定上下文/#技巧-2-引用文件-——-精准指定上下文)
...
### Rules 规则目录[](https://datawhalechina.github.io/easy-vibe/zh-cn/stage-3/core-skills/basics/#rules-规则目录)
...
### 权限提示太多？[](https://datawhalechina.github.io/easy-vibe/zh-cn/stage-3/core-skills/basics/#权限提示太多)
